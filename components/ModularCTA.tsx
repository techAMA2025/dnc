...
export default function ModularCTA() {
  return (
    <section className="w-full bg-[#010D48] py-6 md:py-2 px-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2">
          ...
          >
            <div>
              ...
              {/* Headline */}
              <h2 className="text-3xl sm:text-4xl md:text-6xl font-medium tracking-tighter leading-none text-[#010D48] mb-4">
          ...
          <div className="lg:col-span-5 grid grid-cols-2 gap-2 md:gap-2">
            {[
